...
<body>
	<div class="card">
		<a href="goto_shoppingCar.do" onmouseover="mini_shoppingCar_show()" onmouseout="mini_shoppingCar_hide()">购物车<div class="num">${count}</div></a>
		<div id="mini_shoppingCar_show" style="display: none;">
